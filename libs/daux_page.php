    ...
    class MarkdownPage extends  SimplePage
    {
        ...
        private function initialize_from_file($file, $params) {
            ...
            if ($params['breadcrumbs'])
                $this->breadcrumb_trail = $this->build_breadcrumb_trail($file->parents, false);
            $this->language = '';
        ...
        private function generate_page() {
            ...
            if ($params['request'] === $params['index_key']) {
                ...
                } else $entry_page['Ver documentación <i class="i-derecha"></i>'] = utf8_encode($params['base_page'] . $params['entry_page']->uri);
